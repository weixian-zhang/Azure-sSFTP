...
```  
* cleanDir are Sftp client accounts that you can distribute to clients for them to access and download ClamAV-scanned virus free files from Clean directory /mnt/ssftp/clean 
